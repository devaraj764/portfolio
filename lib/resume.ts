...
export type ResumeData = {
  ...
  leadership: { role: string; duration: string; description: string }[];
  interests: string[];
};
...
export const resumeData: ResumeData = {
  ...
  skills: [
    ...
    },
    {
      ...
      items: "Node.js, Express.js, RESTful API design, Auth & Authorization, File Upload Pipelines"
    },
    {
